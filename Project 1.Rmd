...
#we could use this a bar plot, I need to add something here to make it a side by side bar plot. I need to polish it up too, I'm just trying to get ideas on what this data is/shows right now.

g<-ggplot(orderTB_copy, aes(x= Season))

g + geom_bar()

#We need a side by side box plot and scatter plots with coloring.
```
